// Copyright 2020 Initig LLC.
// Original Source Code Copyright 2019 The Go Cloud Development Kit Authors
//
...
package gocdk_awsdynamo_consistent_read_opener
...
func (o *URLOpener) OpenCollectionURL(_ context.Context, u *url.URL) (*docstore.Collection, error) {
	...
	return awsdynamodb.OpenCollection(db, tableName, partitionKey, sortKey, opts)
}

func (o *URLOpener) processURL(u *url.URL) (db *dyn.DynamoDB, tableName, partitionKey, sortKey string, opts *awsdynamodb.Options, err error) {
	q := u.Query()
	...
	q.Del("sort_key")
	consistentRead := q.Get("consistent_read")
	opts = &awsdynamodb.Options{
		AllowScans:     q.Get("allow_scans") == "true",
		RevisionField:  q.Get("revision_field"),
		ConsistentRead: len(consistentRead) == 0 || consistentRead == "true",
	}
	q.Del("allow_scans")
